    ...
    void put(OCRepresentation& rep)
    {
        ...
        try
        {
            if (rep.getValue("speed", m_speed))
            {
                ...
                string speed_value = string(m_speed);
                   ////send the value returned from above string to the iot.cse.iith.ac.in via curl 
                command = "curl -X POST http://iot.cse.iith.ac.in/action_page.php?fan=speed:"+speed_value;
